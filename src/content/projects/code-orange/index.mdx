...
# [Photo Album](https://photos.app.goo.gl/HGRtCbgeNWHNH5cBA)
...
Following a wish, prefer, demand list, our team determined that being able to fill a rocket on our own was our biggest demand.
We knew the best way to achieve this would be by reducing cycle times of loading and off-loading game pieces as much as possible.
In order to do this we thought of what things are the biggest time consumers during cycles: aligning to load and
