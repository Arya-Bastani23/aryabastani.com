...
var React = _interopRequireWildcard(__webpack_require__(5985));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(5985);
...
var _react = _interopRequireDefault(__webpack_require__(5985));
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-about-js":()=>__webpack_require__.e(/* import() | component---src-pages-about-js */ 682).then(__webpack_require__.bind(__webpack_require__, 5465)),"component---src-pages-blog-js":()=>__webpack_require__.e(/* import() | component---src-pages-blog-js */ 7).then(__webpack_require__.bind(__webpack_require__, 5502)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 6558)),"component---src-pages-projects-js":()=>__webpack_require__.e(/* import() | component---src-pages-projects-js */ 853).then(__webpack_require__.bind(__webpack_require__, 7219))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"icon":"src/images/cow.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"1da21ca2e94d2af2ed66109079efc283"}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const React=__webpack_require__(5985);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(4590);const{parse}=__webpack_require__(698);const styleToOjbect=__webpack_require__(7848);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);var React=_interopRequireWildcard(__webpack_require__(5985));var _gatsby=__webpack_require__(7076);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(5985),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/aryabastani/Documents/Website/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/aryabastani/Documents/Website/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/aryabastani/Documents/Website/node_modules/react/index.js");
...
/******/ 			return "" + {"7":"component---src-pages-blog-js","678":"component---src-pages-index-js","682":"component---src-pages-about-js","853":"component---src-pages-projects-js","883":"component---src-pages-404-js"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(5985);const path=__webpack_require__(1423);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(4590);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(8621);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
